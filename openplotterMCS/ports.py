...
# Copyright (C) 2019 by GeDaD <https://github.com/Thomas-GeDaD/OP-MCSp>
# 
...
class Ports:
	def __init__(self,conf,currentLanguage):
		...
		self.connections.append({'id':connectionId, 'description':_('MCS'), 'data':_('Signal K keys: ')+'Random.Number1, Random.Number2', 'direction':'2', 'type':'UDP', 'mode':'client', 'address':'localhost', 'port':port, 'editable':'1'})
